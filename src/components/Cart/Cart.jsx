...
export default function Cart() {
  ...
  return (<div className=''>
      ...
      {cartDetails === null ?
        <div className=" text-center bg-dark vw-100 bg-opacity-10 position-absolute start-0 margin vh-100 d-flex justify-content-center align-items-center ">
          <div>
            <ThreeDots
              height="80"
              width="200"
      ...
      :cartDetails === 'empty'?
        <div className=" text-center  mt-5 py-5 ">
          <h1 className='mt-5 fw-bolder'>Your cart is empty</h1>
          <Link className='link-offset-2  text-main fs-5' to={'/Products'}>Get some products?</Link>
        </div>
      :
        <>
          <div className='bg-main-light margin p-4 rounded-5'>
            ...
            <div className=" d-flex justify-content-between mb-3 border-bottom   border-dark-subtle">
                  <div>
                      ...
                      <h4 className='text-main h6'>Total Price: {cartDetails.data.totalCartPrice} EGP</h4>
                  </div>
                  <div>
                      <button onClick={clearCart} className="btn btn-outline-danger">Empty Cart</button>
                  </div>
            </div>
            ...
            return  <div key={idx} className="row my-3 py-2 border-bottom ">
                <div className="col-md-1 ">
                  <img  className='w-100 rounded-3 borderwhite w-25' src={product.product.imageCover} alt="" />
                </div>
          ...
          <Link to={'/BuyerData'} className='btn bg-main w-100 mt-5 text-white fs-4'>Checkout</Link >
        </>
